...
public class LinearFunct {
	...
	//returns the intersection with another LinearFunct, null if none exists or an unspecified point if infinite intersections exist
	...
	//returns true if oth linear functions are identical
