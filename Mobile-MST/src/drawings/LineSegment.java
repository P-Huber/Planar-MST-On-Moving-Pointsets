...
public class LineSegment extends JComponent{
	...
	private final boolean drawFinalPosition = false;
	
	public LineSegment() {}
	
	public LineSegment(MovingPoint2D p1, MovingPoint2D p2) {
		//line segments start at their lower point and end at their upper point (left to right in case of tie)
	...
	//returns the euclidean length of a line segment at its initial position
	...
	//returns true if this shares an endpoint with the argument
	...
	//returns true, if a point is strictly within a rectangle (not on the boundary) with this segment as diagonal
	...
	//returns true if this has an intersection with the argument line segment
	...
	//returns true if this crosses the argument LineSegment
	...
	//returns true if this is identical with the argument LineSegment
