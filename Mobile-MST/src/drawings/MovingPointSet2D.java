...
public class MovingPointSet2D extends JComponent{
	...
	//generates points that result in bad results for MovingKruskal
	...
	//add all points contained in the argument to the pointset
	...
	//returns true if the argument LineSegment violates the point criterion on this pointset
	...
	//sort the contained points by their y-axis position
	public void sortY() {
	...
	// set the size of this pointset. REMOVES ALL POINTS!
